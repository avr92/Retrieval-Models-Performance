...
public class IndexData {
	...
	public static List<String> indexData() throws Exception{
        ...
        File[] files = new File("/Users/arima/Documents/IR/Assignment1/Data/AP89_DATA/AP_DATA/ap89_collection").listFiles();
        for (File file : files){
	...
	public static List<String> processQueryFile(){
		...
		try {
			File file = new File("/Users/arima/Documents/IR/Assignment1/Data/AP89_DATA/AP_DATA/query_desc.short.txt");
			BufferedReader br = new BufferedReader(new FileReader(file));
			String line;
			while ((line = br.readLine()) != null) {	
	...
	public static void writeRecords (String fileName, List<ScoreDetails> scores ){
		try {
			FileWriter fw = new FileWriter("/Users/arima/Documents/IR/Assignment1/Data/AP89_DATA/AP_DATA/"+fileName, true);
	...
	public static void writeDocNos(List<String> docNos){
		PrintWriter writer;
		try {
			writer = new PrintWriter("/Users/arima/Documents/IR/Assignment1/Data/AP89_DATA/AP_DATA/docNoWdocCount.txt", "UTF-8");
			int i = 0;
	...
	public static List<String> readDocNos(){
		...
		BufferedReader br;
		try {
			br = new BufferedReader(new FileReader("/Users/arima/Documents/IR/Assignment1/Data/AP89_DATA/AP_DATA/docNoWdocCount.txt"));
			String line = null;
			while ((line = br.readLine()) != null) {
	...
	public static void writeDocumentLengths(Map<String, Integer> docLengths){
		PrintWriter writer;
		try {
			writer = new PrintWriter("C/Users/arima/Documents/IR/Assignment1/Data/AP89_DATA/AP_DATA/docLengths.txt", "UTF-8");
			int i = 0;
	...
	public static Map<String, Integer> readDocumentLengths(){
		...
		BufferedReader br;
		try {
			br = new BufferedReader(new FileReader("/Users/arima/Documents/IR/Assignment1/Data/AP89_DATA/AP_DATA/docLengths.txt"));
			String line = null;
